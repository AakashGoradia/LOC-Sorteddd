...
<section class="text-gray-700 body-font bg-black">
  <div class="container mx-auto flex px-5 lg:py-20 lg:px-4 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center lg:ml-4">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-bold text-white font-lato">Welcome to DigiLocker
...
<section class="text-gray-700 body-font border-t border-gray-200">
  <div class="container px-5 py-16 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h2 class="text-xs text-black tracking-widest font-semibold title-font mb-1 font-lato">Get To Know Us</h2>
      <h1 class="sm:text-3xl text-2xl font-bold title-font text-gray-900 font-lato">OUR SERVICES</h1>
    </div>
    <div class="flex flex-wrap -m-4">
      <div class="p-4 md:w-1/3">
        <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col shadow-2xl">
          <div class="flex items-center mb-3">
            ...
            <h2 class="text-gray-900 text-lg title-font font-semibold font-lato">Online Verification</h2>
          </div>
          <div class="flex-grow">
            <p class="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
            <a href="/" class="mt-3 text-black inline-flex items-center underline">Learn More
      ...
      <div class="p-4 md:w-1/3">
        <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col shadow-2xl">
          <div class="flex items-center mb-3">
            ...
            <h2 class="text-gray-900 text-lg title-font font-semibold font-lato">Document Storage</h2>
          </div>
          <div class="flex-grow">
            <p class="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
            <a href="/" class="mt-3 text-black inline-flex items-center underline">Learn More
      ...
      <div class="p-4 md:w-1/3">
        <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col shadow-2xl">
          <div class="flex items-center mb-3">
            ...
            <h2 class="text-gray-900 text-lg title-font font-semibold font-lato">Updation Services</h2>
          </div>
          <div class="flex-grow">
            <p class="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
            <a href="/" class="mt-3 text-black inline-flex items-center underline">Learn More
...
<section class="text-gray-700 body-font border-t border-gray-200 bg-black">
  <div class="container px-5 py-8 mx-auto">
    <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <p class="leading-relaxed text-lg font-semibold font-lato text-white"> We want to free our citizens from the burden of excessive paper documents in every office. We want paperless transactions. We will set up a digital locker for every citizen to store personal documents that can be shared across departments.</p>
      <span class="inline-block h-1 w-10 rounded bg-gray-400 mt-8 mb-6"></span>
      <h2 class="text-white font-bold font-lato title-font tracking-wider text-sm">NARENDRA MODI</h2>
      <p class="text-white font-medium font-lato">Prime Minister Of India</p>
    </div>
  </div>
</section>
<section class="text-gray-700 body-font border-t border-gray-200">
  <div class="container px-5 py-16 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl title-font mb-2 text-gray-900 font-lato font-bold">DigiLocker Documents</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-base font-semibold">Find and Manage your different type of Documents here.</p>
    </div>
    <div class="flex flex-wrap -m-4">
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          <div class="w-10 h-10 inline-flex items-center justify-center rounded-full bg-gray-200 text-black mb-4">
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6" viewBox="0 0 24 24">
              <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
            </svg>
          </div>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Aadhar Card</h2>
      ...
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">PAN Card</h2>
          <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
        </div>
      </div>
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Birth Certificate</h2>
          <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
        </div>
      </div>
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Citizenship</h2>
          <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
        </div>
      </div>
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Passport</h2>
          <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
        </div>
      </div>
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-300 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Other Documents</h2>
          <p class="leading-relaxed text-base">Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.</p>
        </div>
      </div>
    </div>
...
<section class="text-gray-700 body-font relative">
  ...
  <div class="container px-5 py-8 mx-auto flex">
    <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
      <h2 class="text-gray-900 text-lg mb-1 font-semibold title-font font-lato">Write to Us</h2>
      <p class="leading-relaxed mb-5 text-gray-600 font-medium font-lato">Feel free to reach out to us with anything.</p>
      <input class="bg-white rounded border border-gray-400 focus:outline-none text-base px-4 py-2 mb-4" placeholder="Email" type="email"/>
      <textarea class="bg-white rounded border border-gray-400 focus:outline-none h-32 text-base px-4 py-2 mb-4 resize-none" placeholder="Message"></textarea>
      <button class="inline-flex text-white bg-black py-2 px-6 focus:outline-none hover:bg-gray-400 rounded text-lg border-black border-2 font-medium font-lato">Submit</button>
      <p class="text-xs text-gray-500 mt-3">Your message will be only shared with us and not anybody else.</p>
    </div>
  </div>
</section>
...
<a href="https://github.com/AakashGoradia/LOC-Sorteddd" class="rounded-full w-12 h-12 bg-gray-100 fixed bottom-0 right-0 flex items-center justify-center text-gray-800 mr-8 mb-8 shadow-sm border-gray-300 border"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
